...
public class QuickSortChart extends Application {
    ...
    private static DefaultCategoryDataset createDataSet() {
        ...
        try {
            ...
            in = new Scanner(new FileInputStream("D:\\IDEA\\IdeaProjects\\SoftwareDesign\\file\\performanceAscending.txt"));
            while (in.hasNextLong()) {
                Long count = in.nextLong();
                Long time = in.nextLong();
                lineDataSet.addValue(time, series2, count);
            }
            in = new Scanner(new FileInputStream("D:\\IDEA\\IdeaProjects\\SoftwareDesign\\file\\performanceDescending.txt"));
            while (in.hasNextLong()) {
                Long count = in.nextLong();
                Long time = in.nextLong();
                lineDataSet.addValue(time, series3, count);
            }
            in = new Scanner(new FileInputStream("D:\\IDEA\\IdeaProjects\\SoftwareDesign\\file\\performanceSame.txt"));
            while (in.hasNextLong()) {
                Long count = in.nextLong();
                Long time = in.nextLong();
